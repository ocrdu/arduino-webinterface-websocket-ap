...
unsigned long int debounceStart = 0;
...
const int zdatasize = sizeof(zdata) / sizeof(zdata[0]);
float tdata[] = {20,20,20,20,20,20,20,20,20,20};
const int tdatasize = sizeof(tdata) / sizeof(tdata[0]);
int ledState = 0;
unsigned long int previousCowbellMillis = 0;
unsigned long int previousGravityMillis = 0;
unsigned long int previousTemperatureMillis = 0;
